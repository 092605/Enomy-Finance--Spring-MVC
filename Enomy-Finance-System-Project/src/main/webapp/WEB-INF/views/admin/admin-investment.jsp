...
<c:if test="${empty activeSection or activeSection eq 'active-rules'}">
    ...
    <div class="row g-4 align-items-stretch">
        ...
        <div class="col-lg-7 d-flex">
            <div class="investment-panel-card investment-active-rule-card w-100">
                        ...
                        <c:when test="${not empty activeTaxSet}">
							...
							<div class="investment-tax-switcher">
							    <div class="investment-tax-switch-top">
							        ...
							        <div class="custom-dropdown investment-tax-custom-dropdown" id="activeTaxTypeDropdown">
							            <input type="hidden" id="activeTaxTypeSelect" value="active-tax-none">
