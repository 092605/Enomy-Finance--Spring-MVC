<%-- =========================================================
     ...
     Purpose:
     This JSP file serves as the login page for the
     Enomy Finance system.

     Overview:
     This page allows registered users to authenticate
     their account before accessing secured client or
     ...
     - Provide password show/hide toggle
     - Provide navigation link to signup page
     ...
     - Processes Spring Security authentication
     - Validates registered user credentials
     - Loads user account details from the database
     - Redirects users based on role after successful login
     - Records successful and failed login attempts
     - Displays login, logout, and registration messages
				...
				<div class="col-lg-5 col-md-7 col-sm-10">
					...
					<div class="auth-card">
						...
						<div class="auth-header text-center">
							...
							<p class="auth-subtitle">Access your Enomy Finance tools and
								continue managing your finances smarter.</p>
						</div>
						...
						<form method="post"
							...
							<div class="mb-3">
								...
								<input type="email" id="username" name="username"
									class="form-control auth-input" placeholder="Enter your email"
									required>
							</div>
						...
						<div class="auth-footer text-center">
							<p class="mb-0">
								Don’t have an account? <a
									...
									class="auth-link">Sign up here</a>
							</p>
						</div>
					</div>
