...
<%-- =========================================================
     ...
     Purpose:
     This JSP file serves as the authenticated
     Currency Converter module page for the
     Enomy Finance system.

     Overview:
     This page allows authenticated users to
     perform currency conversion transactions,
     check live exchange rates, review conversion
     rules, and monitor transaction history.

     The module supports both BUY and SELL
     currency conversion workflows using
     dynamically managed conversion fee rules.

     Main Features:
     - Currency buy workflow
     - Currency sell workflow
     - Exchange rate checking
     - Real-time rate preview
     - Currency conversion calculator
     - Dynamic conversion result rendering
     - Conversion fee calculation
     - Transaction receipt generation
     - Transaction history monitoring
     - Active conversion rule viewing
     - AJAX-based rate checking
     - Dynamic result card rendering
     - Inline success and error messaging
     - Partial form rendering workflows
     ...
     - Handles authenticated currency module routing
     - Processes BUY and SELL currency workflows
     - Retrieves live exchange rate data
     - Calculates currency conversions
     - Applies conversion fee rules
     ...
     - Supports partial rendering workflows
     - Supplies authenticated client information
     - Supports secured client-side access control

     Note:
     Exchange rate retrieval currently uses
     integrated API-based conversion logic
     for educational and demonstration purposes.
     Real banking integration and live financial
     settlement systems are outside the current
     project scope.
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/client/client-currency.css">
<link rel="stylesheet"
...
<body class="dashboard-page">
			...
			========================= -->
							<c:if test="${empty activeSection or activeSection eq 'welcome'}">
								...
								<div class="currency-title-card">
									...
									<p>Buy or sell supported currencies using the latest
										available exchange rate.</p>
								</div>
								...
								<div class="row g-4 align-items-stretch">
									...
									<div class="col-lg-7 d-flex">
										<div
											class="currency-panel-card currency-welcome-card w-100 h-100">
											<div class="currency-card-inner">
												<span class="currency-badge">Quick Action</span>
												<h3 class="currency-card-title welcome">Buy or Sell
													Currency</h3>
												<p class="currency-card-text">Start your transaction by
													selecting whether you want to buy or sell currency. The
													system will prepare the converter automatically for your
													chosen transaction type.</p>

												<div class="currency-hero-actions">
													<a
														href="${pageContext.request.contextPath}/client/currency-converter/buy"
														class="btn-glow text-decoration-none text-center"> Buy
														Currency </a> <a
														href="${pageContext.request.contextPath}/client/currency-converter/sell"
												...
												<div class="row g-3">
													...
													<div class="col-md-6">
														...
														<div class="custom-dropdown currency-dropdown">
															<input type="hidden" name="baseCurrency"
																id="checkRateBaseCurrency" value="" />

															<button class="custom-dropdown-toggle" type="button">
																<span class="selected-value">Select</span> <span
																	class="dropdown-arrow"> <svg width="16"
													...
													<div class="col-md-6">
														...
														<div class="custom-dropdown currency-dropdown">
															<input type="hidden" name="targetCurrency"
																id="checkRateTargetCurrency" value="" />
													...
													<div class="col-12">
														<div class="currency-checkrate-actions">
															<button type="button"
																class="btn-glow currency-checkrate-btn"
						...
						========================= -->
							<c:if test="${activeSection eq 'converter'}">
								...
								<div class="currency-title-card">
									...
									<p>Complete the form below to calculate your currency
										transaction.</p>
								</div>
								...
								<div class="row g-4">
										...
										<div class="row g-4">
											...
											<div class="col-12">
												<div class="currency-panel-card">
													<div class="currency-card-inner">
														<h3 class="currency-card-title">Converter Form /
															Calculator</h3>

														<form
															action="${pageContext.request.contextPath}/client/currency-converter/calculate"
															method="post" data-partial-form="true">
															...
															<div class="row g-3">
																...
																<div class="col-12">
																	...
																	<div class="custom-dropdown">
																		<input type="hidden" name="transactionType"
																			value="${conversionRequest.transactionType}" required>

																		<button type="button" class="custom-dropdown-toggle">
																			<span class="selected-value"> <c:choose>
																					<c:when
																						test="${not empty conversionRequest.transactionType}">
																		...
																		<div class="custom-dropdown-menu">
																			<div
																				class="custom-dropdown-item ${empty conversionRequest.transactionType ? 'active' : ''}"
																				data-value="">Select</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.transactionType eq 'BUY' ? 'active' : ''}"
																				data-value="BUY">BUY</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.transactionType eq 'SELL' ? 'active' : ''}"
																				data-value="SELL">SELL</div>
																		</div>
																	</div>
																</div>
																...
																<div class="col-md-6">
																	...
																	<div class="custom-dropdown">
																		<input type="hidden" name="baseCurrency"
																			value="${conversionRequest.baseCurrency}" required>

																		<button type="button" class="custom-dropdown-toggle">
																			<span class="selected-value"> <c:choose>
																					<c:when
																						test="${not empty conversionRequest.baseCurrency}">
																		...
																		<div class="custom-dropdown-menu">
																			<div
																				class="custom-dropdown-item ${empty conversionRequest.baseCurrency ? 'active' : ''}"
																				data-value="">Select</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.baseCurrency eq 'GBP' ? 'active' : ''}"
																				data-value="GBP">GBP</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.baseCurrency eq 'USD' ? 'active' : ''}"
																				data-value="USD">USD</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.baseCurrency eq 'EUR' ? 'active' : ''}"
																				data-value="EUR">EUR</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.baseCurrency eq 'BRL' ? 'active' : ''}"
																				data-value="BRL">BRL</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.baseCurrency eq 'JPY' ? 'active' : ''}"
																				data-value="JPY">JPY</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.baseCurrency eq 'TRY' ? 'active' : ''}"
																				data-value="TRY">TRY</div>
																		</div>
																	</div>
																</div>
																...
																<div class="col-md-6">
																	...
																	<div class="custom-dropdown">
																		<input type="hidden" name="targetCurrency"
																			value="${conversionRequest.targetCurrency}" required>

																		<button type="button" class="custom-dropdown-toggle">
																			<span class="selected-value"> <c:choose>
																					<c:when
																						test="${not empty conversionRequest.targetCurrency}">
																		...
																		<div class="custom-dropdown-menu">
																			<div
																				class="custom-dropdown-item ${empty conversionRequest.targetCurrency ? 'active' : ''}"
																				data-value="">Select</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.targetCurrency eq 'GBP' ? 'active' : ''}"
																				data-value="GBP">GBP</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.targetCurrency eq 'USD' ? 'active' : ''}"
																				data-value="USD">USD</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.targetCurrency eq 'EUR' ? 'active' : ''}"
																				data-value="EUR">EUR</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.targetCurrency eq 'BRL' ? 'active' : ''}"
																				data-value="BRL">BRL</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.targetCurrency eq 'JPY' ? 'active' : ''}"
																				data-value="JPY">JPY</div>
																			<div
																				class="custom-dropdown-item ${conversionRequest.targetCurrency eq 'TRY' ? 'active' : ''}"
																				data-value="TRY">TRY</div>
																		</div>
																	</div>
																</div>
																...
																<div class="col-12">
																	...
																	<div class="enomy-input-wrap">
																		<input type="number" step="0.01" min="0" name="amount"
																			class="enomy-input" placeholder="Enter amount"
														...
														<c:if
															test="${not empty conversionResult and not conversionResult.valid}">
															<div class="inline-error-message show mt-3">
																${conversionResult.message}</div>
														</c:if>
													</div>
												</div>
											</div>
											...
											<div class="col-12">
												<div class="currency-panel-card">
													<div class="currency-card-inner">
														<h3 class="currency-card-title">Conversion Rules
															Details</h3>
														...
														<c:choose>
																	...
																	<table class="table currency-rules-table">
																		...
																		<tbody>
																			<c:forEach var="feeRule" items="${ruleSet.feeRules}">
																				<tr>
																					<td><fmt:formatNumber
																							value="${feeRule.minAmount}"
																							minFractionDigits="2" maxFractionDigits="2" /> -
																						<fmt:formatNumber value="${feeRule.maxAmount}"
																							minFractionDigits="2" maxFractionDigits="2" /></td>
																					<td><fmt:formatNumber
																							value="${feeRule.feeRate}" minFractionDigits="1"
															...
															<c:otherwise>
																<p class="currency-empty-text">No active conversion
																	rules found.</p>
															</c:otherwise>
														</c:choose>
													</div>
									...
									<div class="col-lg-7">
										<div id="resultReceiptArea">
											<div
												class="currency-panel-card currency-result-card cc-narrow
												...
												<div class="currency-card-inner">
													...
													<c:if test="${cardMode eq 'default'}">
														<div class="cc-card-shell">
															<h3 class="currency-card-title cc-card-title-main">Result
																Card</h3>

															<div class="cc-top-strip--grid">
																<div class="cc-top-cell">
																	<span class="cc-top-label">Transaction Type</span> <strong
																		class="cc-top-value">-</strong>
																</div>
																<div class="cc-top-cell">
																	<span class="cc-top-label">Base Currency</span> <strong
																		class="cc-top-value">-</strong>
																</div>
																<div class="cc-top-cell">
																	<span class="cc-top-label">Target Currency</span> <strong
																		class="cc-top-value">-</strong>
																</div>
															</div>

															<div class="cc-amount-bar">
																<span class="cc-bar-label">Amount to Convert</span> <strong
																	class="cc-bar-value">0.00</strong>
															</div>
															...
															<div class="cc-section-block">
																<h4 class="cc-section-title">Fee &amp; Converted
																	Amount</h4>
															...
															<div class="cc-total-bar cc-total-bar--green">
																<span class="cc-bar-label">Final Payable</span> <strong
																	class="cc-bar-value">0.00</strong>
															</div>
													...
													<!-- RESULT -->
													<c:if
														test="${cardMode eq 'result' and not empty conversionResult}">
														<div class="cc-card-shell">
															<h3 class="currency-card-title cc-card-title-main">Result
																Card</h3>

															<c:if
																test="${not empty conversionResult and conversionResult.valid}">
															...
															<div class="cc-top-strip--grid">
																<div class="cc-top-cell">
																	<span class="cc-top-label">Transaction Type</span> <strong
																		class="cc-top-value"> <c:out
																			value="${conversionResult.transactionType}"
																			default="-" />
																	</strong>
																</div>
																<div class="cc-top-cell">
																	<span class="cc-top-label">Base Currency</span> <strong
																		class="cc-top-value"> <c:out
																			value="${conversionResult.baseCurrency}" default="-" />
																	</strong>
																</div>
																<div class="cc-top-cell">
																	<span class="cc-top-label">Target Currency</span> <strong
																		class="cc-top-value"> <c:out
																			value="${conversionResult.targetCurrency}"
																			default="-" />
																	</strong>
																</div>
															</div>
															...
															<div class="cc-amount-bar">
																<span class="cc-bar-label">Amount to Convert</span> <strong
																	class="cc-bar-value"> <c:choose>
																		<c:when
																			test="${conversionResult.baseCurrency eq 'USD'}">$</c:when>
																		<c:when
																			test="${conversionResult.baseCurrency eq 'GBP'}">£</c:when>
																		<c:when
																			test="${conversionResult.baseCurrency eq 'EUR'}">€</c:when>
																		<c:when
																			test="${conversionResult.baseCurrency eq 'JPY'}">¥</c:when>
																		<c:when
																			test="${conversionResult.baseCurrency eq 'BRL'}">R$</c:when>
																		<c:when
																			test="${conversionResult.baseCurrency eq 'TRY'}">₺</c:when>
																		<c:otherwise>${conversionResult.baseCurrency} </c:otherwise>
																	</c:choose> <fmt:formatNumber
																		value="${conversionResult.inputAmount}"
																		minFractionDigits="2" maxFractionDigits="2" />
																</strong>
															</div>
															...
															<div class="cc-section-block">
																...
																<div class="cc-detail-grid">
																	...
																	<div class="cc-detail-values">
																		<div>
																			<fmt:formatNumber
																				value="${conversionResult.exchangeRateUsed}"
																				minFractionDigits="2" maxFractionDigits="6" />
																		</div>
																		<div>
																			<fmt:formatDate
																				value="${conversionResult.retrievedAt}"
																				pattern="MMM dd, yyyy" />
																		</div>
																		<div>
																			<fmt:formatDate
																...
																<div class="cc-detail-grid">
																	...
																	<div class="cc-detail-values">
																		<div>
																			<c:choose>
																				<c:when
																					test="${conversionResult.targetCurrency eq 'USD'}">$</c:when>
																				<c:when
																					test="${conversionResult.targetCurrency eq 'GBP'}">£</c:when>
																				<c:when
																					test="${conversionResult.targetCurrency eq 'EUR'}">€</c:when>
																				<c:when
																					test="${conversionResult.targetCurrency eq 'JPY'}">¥</c:when>
																				<c:when
																					test="${conversionResult.targetCurrency eq 'BRL'}">R$</c:when>
																				<c:when
																					test="${conversionResult.targetCurrency eq 'TRY'}">₺</c:when>
																				<c:otherwise>${conversionResult.targetCurrency} </c:otherwise>
																			</c:choose>
																			<fmt:formatNumber
																				value="${conversionResult.convertedAmount}"
																				minFractionDigits="2" maxFractionDigits="2" />
																		</div>
																		<div>
																			<fmt:formatNumber
																				value="${conversionResult.feeRateApplied}"
																		...
																		<div>
																			<c:choose>
																				<c:when
																					test="${conversionResult.transactionType eq 'BUY'}">
																					<c:choose>
																						<c:when
																							test="${conversionResult.baseCurrency eq 'USD'}">$</c:when>
																						<c:when
																			...
																			<fmt:formatNumber
																				value="${conversionResult.feeValue}"
																				minFractionDigits="2" maxFractionDigits="2" />
																		</div>
																	</div>
																</div>
															...
															<div class="cc-total-bar cc-total-bar--green">
																<span class="cc-bar-label"> <c:out
																		value="${conversionResult.finalLabel}"
																		default="Final Payable" />
																</span> <strong class="cc-bar-value"> <c:choose>
																		<c:when
																			test="${conversionResult.transactionType eq 'BUY'}">
																			<c:choose>
																				<c:when
																		...
																		value="${conversionResult.finalAmount}"
																		minFractionDigits="2" maxFractionDigits="2" />
																</strong>
															</div>
															...
															<div class="currency-result-actions cc-action-row">
																<a
																	href="${pageContext.request.contextPath}/client/currency-converter/cancel?transactionType=${conversionRequest.transactionType}"
																	class="btn-glow-outline text-decoration-none text-center cc-action-btn"
																	data-partial-link="true"> Cancel </a>

																<form
																	action="${pageContext.request.contextPath}/client/currency-converter/confirm"
																	method="post" class="m-0" data-partial-form="true">
																	<input type="hidden" name="transactionType"
																		value="${conversionRequest.transactionType}">
																	<input type="hidden" name="baseCurrency"
																		value="${conversionRequest.baseCurrency}"> <input
																		type="hidden" name="targetCurrency"
																		value="${conversionRequest.targetCurrency}"> <input
																	...
																	<button type="submit" class="btn-glow cc-action-btn">
																		<c:choose>
																			<c:when
																				test="${conversionRequest.transactionType eq 'BUY'}">Buy Now</c:when>
													...
													<c:if test="${cardMode eq 'receipt' and not empty receipt}">
														<div class="cc-card-shell">
															<h3 class="currency-card-title cc-card-title-main">Transaction
																Receipt</h3>
															...
															<div class="cc-meta-block">
																<div class="cc-meta-row">
																	<span class="cc-meta-label">Transaction Number</span> <strong
																		class="cc-meta-value">${receipt.transactionNumber}</strong>
																</div>
																<div class="cc-meta-row">
																	<span class="cc-meta-label">Date:</span> <strong
																		class="cc-meta-value"> <fmt:formatDate
																			value="${receipt.date}" pattern="MMM dd, yyyy" />
																	</strong>
																</div>
															</div>
															...
															<div class="cc-top-strip--grid">
																<div class="cc-top-cell">
																	<span class="cc-top-label">Transaction Type</span> <strong
																		class="cc-top-value"> <c:out
																			value="${receipt.transactionType}" default="-" />
																	</strong>
																</div>
																<div class="cc-top-cell">
																	<span class="cc-top-label">Base Currency</span> <strong
																		class="cc-top-value"> <c:out
																			value="${receipt.baseCurrency}" default="-" />
																	</strong>
																</div>
																<div class="cc-top-cell">
																	<span class="cc-top-label">Target Currency</span> <strong
																		class="cc-top-value"> <c:out
																			value="${receipt.targetCurrency}" default="-" />
																	</strong>
																</div>
															</div>
															...
															<div class="cc-amount-bar">
																<span class="cc-bar-label">Amount to Convert</span> <strong
																	...
																	</c:choose> <fmt:formatNumber value="${receipt.inputAmount}"
																		minFractionDigits="2" maxFractionDigits="2" />
																</strong>
															</div>
															...
															<div class="cc-section-block">
																...
																<div class="cc-detail-grid">
																	...
																	<div class="cc-detail-values">
																		<div>
																			<fmt:formatNumber value="${receipt.exchangeRateUsed}"
																				minFractionDigits="2" maxFractionDigits="6" />
																		</div>
																		<div>
																			<fmt:formatDate value="${receipt.date}"
																				pattern="MMM dd, yyyy" />
																		</div>
																		<div>
																			<fmt:formatDate value="${receipt.date}"
																...
																<div class="cc-detail-grid">
																	...
																	<div class="cc-detail-values">
																		<div>
																			...
																			<fmt:formatNumber value="${receipt.convertedAmount}"
																				minFractionDigits="2" maxFractionDigits="2" />
																		</div>
																		<div>
																			<fmt:formatNumber value="${receipt.feeRateApplied}"
																				minFractionDigits="1" maxFractionDigits="2" />
																			%
																		</div>
																		<div>
																			...
																			<fmt:formatNumber value="${receipt.feeValue}"
																				minFractionDigits="2" maxFractionDigits="2" />
																		</div>
																	</div>
																</div>
															...
															<div class="cc-total-bar cc-total-bar--green">
																<span class="cc-bar-label"> <c:out
																		value="${receipt.label}" default="Paid Amount" />
																</span> <strong class="cc-bar-value"> <c:choose>
																		<c:when test="${receipt.transactionType eq 'BUY'}">
																			<c:choose>
																				<c:when test="${receipt.baseCurrency eq 'USD'}">$</c:when>
																	...
																	</c:choose> <fmt:formatNumber value="${receipt.finalAmount}"
																		minFractionDigits="2" maxFractionDigits="2" />
																</strong>
															</div>

															<div
																class="currency-result-actions cc-action-row cc-action-row--center">
																<a
																	href="${pageContext.request.contextPath}/client/currency-converter/okay?transactionType=${receipt.transactionType}"
																	class="btn-glow text-decoration-none text-center cc-action-btn"
																	data-partial-link="true"> Okay </a>
															</div>
														</div>
													</c:if>
										...
										<c:choose>
																...
																<c:forEach var="item" items="${historyList}">
																	<tr>
																		...
																		<td><c:choose>
																			...
																			</c:choose> <fmt:formatNumber value="${item.inputAmount}"
																				minFractionDigits="2" maxFractionDigits="2" /></td>
																		<td><c:choose>
																			...
																			</c:choose> <fmt:formatNumber value="${item.finalAmount}"
																				minFractionDigits="2" maxFractionDigits="2" /></td>
																	</tr>
																</c:forEach>
															</tbody>
											...
											<c:otherwise>
												<div class="currency-empty-state">
													...
													<p>Your completed currency transactions will appear
														here.</p>
												</div>
											</c:otherwise>
										</c:choose>
							...
							<div class="currency-module-sidebar-wrap">
								<div class="currency-module-sidebar">
									...
									<a
										...
										<div>
											<strong>Currency Converter</strong> <small>Back to
												Welcome</small>
										</div>
									</a>
									...
									<nav class="currency-module-nav">
										<a
											href="${pageContext.request.contextPath}/client/currency-converter/history"
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/client/client-currency.js"></script>
