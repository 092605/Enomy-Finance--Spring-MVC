                                ...
                                <div class="profile-overview-wrap">
                                    <div class="profile-avatar-area">
                                        ...
                                        <div class="profile-avatar-actions">
                                            <button type="button" class="profile-btn profile-btn-primary mb-2 w-100" id="openPhotoChoiceModalBtn">
                                                Change Photo
                                            </button>
                                            <input type="file" id="profileImageInput" accept=".png,.jpg,.jpeg,.webp" hidden>
                                            <button type="button" class="profile-btn profile-btn-secondary w-100" id="removePhotoBtn">
                                                Remove
                                            </button>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-sm-6">
                                                <div class="profile-info-tile">
                                                    ...
                                                    <span class="profile-info-value" id="profileClientId">CL-${user.id}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="profile-info-tile">
                                                    ...
                                                    <span class="profile-info-value" id="profileAccountType">Client Account</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="profile-info-tile">
                                                    ...
                                                    <span class="profile-info-value" id="profileJoinedDate">
                                                        <c:choose>
                                    ...
                                    <div class="col-12">
                                        <div class="profile-security-meta">
                                            <div class="profile-security-meta-row">
                                                ...
                                                <strong id="lastFailedLogin">
                                                    <c:choose>
                                                        <c:when test="${not empty profileData.lastFailedLogin and not empty profileData.lastFailedLogin.attemptedAt}">
                                                            <fmt:formatDate value="${profileData.lastFailedLogin.attemptedAt}" pattern="MMM dd, yyyy hh:mm a" />
                                                        </c:when>
                                                        <c:otherwise>—</c:otherwise>
                                                    </c:choose>
                                                </strong>
                                                ...
                                                <strong id="passwordLastUpdated">
                                                    <c:choose>
                                                        <c:when test="${not empty user.passwordUpdatedAt}">
                                                            <fmt:formatDate value="${user.passwordUpdatedAt}" pattern="MMM dd, yyyy hh:mm a" />
                                                        </c:when>
                                                        <c:otherwise>—</c:otherwise>
                                                    </c:choose>
                                                </strong>
                                ...
                                <form id="profileInfoForm" novalidate>
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            >
                                            <div class="profile-field-hint">This name will be displayed across your account.</div>
                                        </div>

                                        <div class="col-12">
                                            <label class="profile-form-label" for="emailReadOnly">Email Address</label>
                                            <input
                                                type="email"
                                    ...
                                    <div class="profile-form-actions mt-4">
                                        ...
                                        <button type="button" class="profile-btn profile-btn-secondary" id="resetProfileBtn">
                                            Reset
                                        </button>
                                    </div>
                                </form>
                        ...
                        <div class="profile-card h-100">
                            <div class="profile-card-inner">
                                ...
                                <form id="changePasswordForm" novalidate>
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <div class="profile-password-wrap">
                                                ...
                                                >
                                                <button type="button" class="profile-password-toggle" data-target="currentPassword">
                                                    Show
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="profile-password-wrap">
                                                ...
                                                >
                                                <button type="button" class="profile-password-toggle" data-target="newPassword">
                                                    Show
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="profile-password-strength">
                                                <span class="profile-password-strength-label">Password Strength</span>
                                                <span class="profile-password-strength-value" id="passwordStrengthText">Not entered</span>
                                            </div>
                                    ...
                                    <div class="profile-form-actions mt-4">
                                        <button type="submit" class="profile-btn profile-btn-primary" id="updatePasswordBtn">
                                            Update Password
                                        </button>
                                        <button type="button" class="profile-btn profile-btn-secondary" id="clearPasswordBtn">
                                            Clear
                                        </button>
                                    </div>
                                </form>
                        ...
                        <div class="profile-card">
                            <div class="profile-card-inner">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-3">
                                        <div class="profile-info-tile">
                                            <span class="profile-info-label">Registered Email</span>
                                            <span class="profile-info-value" id="accountEmail">${user.email}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 col-xl-3">
                                        <div class="profile-info-tile">
                                            ...
                                            <span class="profile-info-value" id="accountStatusValue">${user.enabled ? 'Active' : 'Disabled'}</span>

                                            <button type="button"
                                                    class="profile-delete-link"
                                                    id="openDeleteAccountModalBtn">
                                                Delete Account?
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 col-xl-3">
                                        <div class="profile-info-tile">
                                            <span class="profile-info-label">Created On</span>
                                            <span class="profile-info-value" id="accountCreatedDate">
                                                <c:choose>
                                                    <c:when test="${not empty user.createdAt}">
                                                        <fmt:formatDate value="${user.createdAt}" pattern="MMM dd, yyyy" />
                                                    </c:when>
...
<!-- Photo Choice Modal -->
<div class="profile-photo-modal-overlay d-none" id="profilePhotoModalOverlay">
    <div class="profile-photo-modal-card">
        <div class="profile-photo-modal-header">
            <div>
                ...
                <p class="profile-photo-modal-subtitle">
                    Upload a photo from your device or select one of the available avatars.
                </p>
            </div>
...
<div class="profile-delete-modal-overlay d-none" id="profileDeleteModalOverlay">
