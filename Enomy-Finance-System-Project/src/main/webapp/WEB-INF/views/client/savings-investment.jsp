                    ...
                    <div class="investment-quotes-panel">
                        <div class="investment-card-inner investment-quotes-card">
                            ...
                            <div class="investment-quotes-header">
                                <div>
                                    <h3 class="investment-quotes-title">Saved Investment Quotes</h3>
                                ...
                                <c:choose>
                                    <c:when test="${not empty savedQuotes}">
                                        <div class="table-responsive">
                                            <table class="table investment-quotes-table align-middle mb-0">
                                                <thead>
                                                    <tr>
                                                        <th>Quote ID</th>
                                                        <th>Plan Type</th>
                                                ...
                                                <tbody>
                                                    <c:forEach var="quote" items="${savedQuotes}">
                                                        <tr>
                                                            ...
                                                            <td>£<fmt:formatNumber value="${quote.initialLumpSum}" type="number" minFractionDigits="2" maxFractionDigits="2"/></td>
                                                            <td>£<fmt:formatNumber value="${quote.monthlyInvestment}" type="number" minFractionDigits="2" maxFractionDigits="2"/></td>
                                                            <td>
                                                                <fmt:formatDate value="${quote.createdAt}" pattern="dd MMM yyyy, hh:mm a"/>
                                                            </td>
                                    ...
                                    <c:otherwise>
                                        <div class="investment-empty-state">
                                            ...
                                            <p>Your saved investment quotes will appear here once you save one from the calculator.</p>
                                            <button type="button"
                                                    class="btn-glow-outline investment-back-btn"
                                                    id="backToCalculatorBtnEmpty">
                                                Back to Calculator
                                            </button>
                                        </div>
                                    </c:otherwise>
